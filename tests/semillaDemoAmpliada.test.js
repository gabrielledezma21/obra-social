...
test('la semilla ampliada contiene una distribución mensual conocida por plan', () => {
  ...
  assert.match(semilla, /'2026-01': \{ '210': 1, '310': 0, '410': 2, '510': 3 \}/);
  assert.match(semilla, /'2026-02': \{ '210': 0, '310': 1, '410': 3, '510': 1 \}/);
  assert.match(semilla, /'2026-03': \{ '210': 4, '310': 3, '410': 4, '510': 2 \}/);
});
